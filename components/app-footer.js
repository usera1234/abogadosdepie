        ...
        this.innerHTML = `
            ...
            <div id="footer" class="footer-container">                                                              <!--Pie de pagina-->
                <div class="footer-row">
                    <div class="footer-row">                                                                      <!--Logo pie de pagina-->
                    ...
                    <div class="footer-row" style="gap:20rem;">                                                  <!--Botones redes-->
                    <div class="footer-row" style="gap:2rem;">
                        <div id="twitter" class="footer-row">                                                    <!--Twitter-->
                        ...
                        <div id="Facebook" class="footer-row">                                                   <!--Facebook-->
                        ...
                        <div id="instagram" class="footer-row">                                                  <!--Instagram-->
