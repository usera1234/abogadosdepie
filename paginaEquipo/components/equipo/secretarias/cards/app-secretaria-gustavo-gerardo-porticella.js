class AppSecretariaGustavoGerardoPorticella extends HTMLElement {
    constructor(){
        super()
...
customElements.define('app-secretaria-gustavo-gerardo-porticella',AppSecretariaGustavoGerardoPorticella)