class AppSecretariaMartinaDelValleAgosti extends HTMLElement {
    constructor(){
        super()
...
customElements.define('app-secretaria-martina-del-valle-agosti',AppSecretariaMartinaDelValleAgosti)