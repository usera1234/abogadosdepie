class AppAutoridadesFernandoFelder extends HTMLElement {
    constructor(){
        super()

        this.innerHTML = `
                    <div class="listEquipoItem">
                        <img src="static/imagenes/equipo/socios/fernandoFelder.jpg" alt="Fernando Felder" class="listEquipoImg">
                        <div class="listEquipoTitle">Fernando Felder</div>
                        <div class="listEquipoRedes">
                            <div class="listEquipoRedesRow">
                                ...
                                <p class="listEquipoRedesText">Prosecretario general</p>
                            </div>
                            <div class="listEquipoRedesRow">
...
customElements.define('app-autoridades-fernando-felder',AppAutoridadesFernandoFelder)