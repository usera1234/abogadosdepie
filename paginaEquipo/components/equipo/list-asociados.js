class AppListAsociados extends HTMLElement {
    constructor() {
        super();
        this.innerHTML = `
            <div class="listEquipoContainer">
                <div class="listEquipoRow">
                    <div class="listEquipoItem">
                        ...
                        <div class="listEquipoTitle">Marcelo Lolaxon Dominguez</div>
...
customElements.define('list-asociados', AppListAsociados);    