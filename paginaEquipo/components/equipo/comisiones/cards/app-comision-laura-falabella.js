class AppComisionLauraFalabella extends HTMLElement {
    constructor(){
        super()
                    ...
                    <div class="listEquipoItem">
                        ...
                        <div class="listEquipoRedes">
                            <div class="listEquipoRedesRow">
                                ...
                                <p class="listEquipoRedesText">Directora</p>
                            </div>
                            <div class="listEquipoRedesRow">
...
customElements.define('app-comision-laura-falabella',AppComisionLauraFalabella)